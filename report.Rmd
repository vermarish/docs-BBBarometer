...
<!-- deprecated because we build models easily now
```{r}
...
threshold_pressure <- function(result, threshold=0.4) {
  ...
  occurrence <- data.frame(type="touch_predict",
             time=occurrence,
             one=0,
             two=0,
             three=0,
...
threshold_pressure(result_pair$training, threshold=0.3)
```
