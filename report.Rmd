...
scatterplot_pressure_model <- function(data, touch_confidence, a, b) {
...
a = 0.5
w = 0.1
scatterplot_pressure_model(data, touch_confidence, a=a, b=a+w)
```
...
```{r}
thresholded <- threshold_pressure(touch_confidence, threshold=0.5) %>%
